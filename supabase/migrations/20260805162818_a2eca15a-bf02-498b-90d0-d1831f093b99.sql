...
ALTER TABLE public.cotizaciones ADD CONSTRAINT cotizaciones_estado_check CHECK (estado = ANY (ARRAY[
  'pendiente','nueva','en_revision','cotizada','aceptada','rechazada','cancelada','asignada',
  'lista_para_operar','confirmada','en_operacion','finalizada','cobro_pendiente','cerrada'
]));