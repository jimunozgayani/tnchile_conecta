...
import { LayoutDashboard, User, Truck, Users, DollarSign, FileText, LogOut, Menu, X, ShieldCheck, MessageSquare, Briefcase, History as HistoryIcon, Building2, Handshake, Inbox, Search } from "lucide-react";
          ...
          {(isAdmin || isOperador) && (
            <>
              ...
              <div className="mt-4 border-t border-sidebar-border pt-3">
                ...
                {isAdmin && (
                <Link to="/admin-gestion" onClick={() => setOpen(false)}
                  className={`mt-1 flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors ${
                    location.pathname.startsWith("/admin-gestion") ? "bg-sidebar-primary text-sidebar-primary-foreground" : "hover:bg-sidebar-accent"
                  }`}>
                  <ShieldCheck className="h-4 w-4" />
                  Gestión total
                </Link>
